    ...
    a.fn.number_slideshow=function(p){
        ...
        function play(){
            if(n=="enable"){
                ...
                F.find(".number_slideshow_nav").children("li").css("background-color",z).removeClass("current");
                F.find(".number_slideshow_nav").children("li").eq(E).css("background-color",A).addClass("current");
                E++;
                if(E>=G){
                    E=0
                }
        ...
        function stop(a){
            ...
            if(b != (E-1)){
                ...
                */
                ...
                F.find(".number_slideshow_nav").children("li").css("background-color",z).removeClass("current");
                F.find(".number_slideshow_nav").children("li").eq(b).css("background-color",A).addClass("current");
            }
        }
